...
//        statement.close();
    ...
    @Override
    public ResultSet create(String firstName, String lastName, String middleName) throws SQLException {
        Statement statement = connection.createStatement();
        String SQL_ADD_A_NEW_CUSTOMER = "INSERT INTO customers (secondname, firstname, middlename) VALUES ('" + lastName + "', '" + firstName + "', '" + middleName + "') RETURNING *;";
...
//        statement.close();
    ...
    @Override
    public ResultSet update(String id, String firstName, String lastName, String middleName) throws SQLException {
        Statement statement = connection.createStatement();
        String SQL_CHANGE_A_CUSTOMER = "UPDATE customers SET secondname = '" + lastName + "', firstname = '" + firstName + "', middlename = '" + middleName + "' WHERE id = '" + id + "' RETURNING *;";
